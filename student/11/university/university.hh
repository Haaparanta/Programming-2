...
const std::string ALLREYDY_IN_COURSE = "Error: Student has already registered on this course.";
...
private:
    ...
    /**
     * @brief course_not_exist Helper functio
     * @param course
     * @return true if course does't exist.
     */
    bool course_not_exist(std::string course);

    /**
     * @brief account_not_exist Helper functio
     * @param account
     * @return true if account does't exist
     */
    bool account_not_exist(std::string account);

    /**
     * @brief instance_not_exist
     * @param course
     * @param instance
     * @return true if instance does't exist
     */
    bool instance_not_exist(std::string course, std::string instance);
