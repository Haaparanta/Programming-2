...
Square::Square( int x, int y, int drops, Board* board ): x_(x), y_(y), drops_(drops), board_(board) {
   // Square has been initialized with too much water, it pops before game starts :)
